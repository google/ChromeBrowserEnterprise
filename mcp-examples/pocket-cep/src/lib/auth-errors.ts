  ...
  switch (code) {
    ...
    case "invalid_rapt":
      return {
        ...
        remedy: isSaMode
          ? "Verify your credentials and OAuth scopes on the /sa-setup page."
    ...
    case "invalid_grant":
      return {
        ...
        remedy: isSaMode
          ? "Verify your Service Account key and Domain-Wide Delegation on the /sa-setup page."
    ...
    case "no_adc":
      return {
        ...
        remedy: isSaMode
          ? "Configure your Service Account credentials on the /sa-setup page."
    ...
    case "unauthenticated":
      return {
        ...
        source,
        message: isSaMode
          ? "Google rejected the Service Account request (UNAUTHENTICATED)."
          : "Google rejected the request (UNAUTHENTICATED).",
        remedy: isSaMode
          ? "Ensure your Service Account has valid Domain-Wide Delegation scopes on the /sa-setup page."
    ...
    case "unknown_auth":
      return {
        ...
        remedy: isSaMode
          ? "Re-verify your Service Account setup on the /sa-setup page."
          : "Run `gcloud auth login` and retry.",
        command: isSaMode ? undefined : "gcloud auth login",
        docsUrl,
      };
