# cbcm-browser-extension-profile-export
...
ORG_UNIT_PATH = ""
# CSV Filename
CSV_FILENAME = "cbcm-browser-extension-profile-export.csv"
         ...
         for browser in device['browsers']:
            ...
            for profile in browser['profiles']:
               ...
               for extension in profile['extensions']:
                  ...
                  extensionVersion = extension.get('version', ''),
                  extensionName = extension.get('name', ''),
                  extensionPermissions = extension.get('permissions', ''),
                  extensionInstallType = extension.get('installType', '')
